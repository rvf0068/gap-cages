#############################################################################
##  
##  PackageInfo.g for the package `cages'            Rafael Villarroel-Flores
...
##  one line.
Subtitle := "GAP Package for cage graphs",
...
# utilities.",
AbstractHTML := 
  "The <span class=\"pkgname\">cages</span> package, deals \
...
PackageDoc := rec(
  ...
  Archive := 
      "http://www/cages/cagesdoc-0.1.tar.bz2",
...
Dependencies := rec(
  ...
  NeededOtherPackages := [["GRAPE", ">=4,2"],["DESIGN", ">1.3"]],
